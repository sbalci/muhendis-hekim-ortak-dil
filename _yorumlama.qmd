...
if (!file.exists("./qrcodes/qupath-spider.svg")) {

  qrcode_svg <- qrcode::qr_code("https://www.youtube.com/watch?v=8tLORQ7yUIQ")

  qrcode::generate_svg(qrcode = qrcode_svg,
                       filename = "./qrcodes/qupath-spider.svg",
                       show = FALSE)
}
```
...
![](./media/model-degerlendirme.png)

:::

::: {.column width="20%" .r-stretch}
![QuPath & histAI SPIDER Colorectal Model](./qrcodes/qupath-spider.svg)

`r fontawesome::fa("github", fill = fa_fill)` [sbalci/spider-qupath](https://github.com/sbalci/spider-qupath)
